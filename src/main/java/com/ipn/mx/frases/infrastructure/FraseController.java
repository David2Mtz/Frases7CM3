...
public class FraseController {
    ...
    @GetMapping("/frase/enviar-email")
    public ResponseEntity<?> enviarFrasePorEmail(@RequestParam String email) {
        Map<String, Object> response = new HashMap<>();
        try {
            servicio.enviarFrasePorEmail(email);
            response.put("mensaje", "Correo enviado con éxito a: " + email);
